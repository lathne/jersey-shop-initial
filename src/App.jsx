    ...
    return ( 
        <>
            <section className="items">
                ...
                {/* para cada item dentro da variavel/array 'items' traga as propriedades e valores desses objetos*/}
          ...
          {/* esse foi o código inicial que foi substituído pelo loop acima     
